...
// Associations
PublicComplaint.associate = (models) => {
  PublicComplaint.belongsTo(models.Employee, {
    foreignKey: 'employee_id',
    as: 'employee',
  });

  PublicComplaint.belongsTo(models.Admin, {
  ...
  PublicComplaint.belongsTo(models.Department, {
  ...
  PublicComplaint.belongsTo(models.Sector, {
    foreignKey: 'sector_id',
    as: 'sector',
  });
  PublicComplaint.belongsTo(models.Team, {
    foreignKey: 'team_id',
    as: 'team',
  });

  PublicComplaint.belongsTo(models.Office, {
